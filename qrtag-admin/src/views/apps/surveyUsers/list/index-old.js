        ...
        <>
            ...
            {editInfo && (
                <Modal isOpen={viewModal} toggle={() => setViewModal(!viewModal)} className='modal-dialog-centered' size="sm">
                    <ModalHeader toggle={() => setViewModal(!viewModal)}>View User Details</ModalHeader>
                    <ModalBody>
                        <Row>
                            ...
                            <Col md='12' className="mb-1"><strong>Contact</strong> <dd>{editInfo && editInfo.phone_number ? editInfo.phone_number : '-'}</dd></Col>
                        </Row>
                    </ModalBody>
                </Modal>
            )}
