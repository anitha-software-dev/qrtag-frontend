...
const Blog4 = () => {
  ...
  return (
    <section className=" position-relative">
      ...
      <div className="text-center team-heading mobile-heading">
        <p className="text-white blue-text-style cs_fs_22">BLOGS</p>
        <h2 className="cs_fs_60 text-white">
          Smart Tips <span className="peach-text">& Stories</span>
        </h2>
      </div>
            ...
            {(blogs || []).map((item: any, i: number) => (
              <div key={i} className="col-lg-4 col-md-6 col-sm-12 wow fadeInLeft">
                <article className="cs_post cs_style_1 cs_type_1 h-100">
                  ...
                  <div className="cs_post_content cs_white_bg blog-card p-3">
      ...
      <div className="cs_height_120 cs_height_lg_100"></div>
    </section>
  );
};
